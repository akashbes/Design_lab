			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Mobile number is required">
						<input class="input100" type="tel" name="mobile" placeholder="Mobile number" max="10" min="10">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
					...
					<div class="container-login100-form-btn">
						<input class="login100-form-btn" type="submit" value="Create" name="create">
					</div>
				</form>
					<div class="container-login100-form-btn pos">
